...
var c1 = 255.0
var c2 = 0.0
var bg = vgoLinearGradient(x, y+h, x, y, vgoRGBA(c1, c1, c1, 16), vgoRGBA(c2, c2, c2, 20))
...
var btnx = x + w / 2 - sysGetTextWidth(text) / 2
var btny = y + h / 2 - 1

ctx.SetFontBlur(1.0)
ctx.SetFillColor(vgoRGBA(0, 0, 0, 255))
ctx.Text(btnx, btny+1, text)

ctx.SetFontBlur(0.0)
ctx.SetFillColor(vgoRGBA(155, 155, 155, 250))
ctx.Text(btnx, btny+1, text)